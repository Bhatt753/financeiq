...
# Step 1: Data Input + Metrics Calculation
...
def get_user_info():
    ...
    # Auto capture current month and year
...
# Healthy spending limits (industry standard)
HEALTHY_LIMITS = {
    "Rent/Housing"     : 30,
    "Food & Groceries" : 20,
    "Transport"        : 15,
...
def export_to_csv(user, expenses, metrics, user_id):
    ...
    filename = f"{export_folder}/finance_{user['name']}_{user['month']}_{user['year']}.xlsx"
...
def generate_insights(user, metrics):
    if __name__ == "__main__":
        ...
        print("DEBUG: About to export...")
        try:
            export_to_csv(user, expenses, metrics, user_id)
        except Exception as e:
            print(f"  ❌ Export error: {e}")

        goal_planning(metrics)        # ← THIS LINE
    ...
    # ============================================================
        ...
        # --- Insight 2: Category reduction insights ---
        for cat, amt in category_totals.items():
        ...
        # --- Insight 4: Fixed vs Variable analysis ---
        ...
        # --- Insight 5: Emergency fund status ---
        ...
        # --- Insight 6: Biggest expense warning ---
        ...
        # --- Insight 7: Investment potential ---
        if savings > 0:
